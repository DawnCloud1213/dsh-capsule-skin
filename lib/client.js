...
body[data-ds-skin="capsule"] [class*="composerSeat"] [contenteditable="true"],
body[data-ds-skin="capsule"] [class*="composerSeat"] input {
  background: transparent !important;
  color: #ffffff !important;
}
...
/* 首页 hero 输入卡片（uV2eYG_card 等带 textarea 的卡片容器） */
body[data-ds-skin="capsule"] [class*="centerCol"] [class*="card"] {
  background: rgba(30, 16, 16, 0.55) !important;
  border: 1px solid rgba(255, 236, 235, 0.10) !important;
  backdrop-filter: blur(14px);
  -webkit-backdrop-filter: blur(14px);
