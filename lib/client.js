...
body[data-ds-skin="capsule"] [class*="centerCol"] [class*="card"]:has(textarea) {
  background: rgba(30, 16, 16, 0.34) !important;
  border: 1px solid rgba(255, 236, 235, 0.12) !important;
...
/* 内层输入胶囊：重材质聚焦层 + 内高光。textarea 是绝对定位拉伸层
   （top/bottom 已为 0），height/width 取 auto 让它跟随外层高度；
   padding 是真正的上下呼吸空间，不再与 dsh 的动态高度机制打架。 */
