...
// ============================================================
// wallpaper-lab 模块：壁纸美化（滤镜/氛围/色调/水印/取景/预设）
// 独立注册 /wallpaper-lab 路由，客户端模块见 client.js
// ============================================================
const _wpLabIndex = (() => {
  const path = require('node:path');
  return {
...
// 注册 wallpaper-lab 子模块
try {
  module.exports.__wallpaperLab = _wpLabIndex;
  if (typeof module.exports.apply === 'function') {
    const _origApply = module.exports.apply;
    module.exports.apply = function(ctx) {
      const r = _origApply.call(this, ctx);
      try { _wpLabIndex.apply(ctx); } catch (e) { console.warn('wallpaper-lab apply failed', e); }
      return r;
    };
  }
} catch (e) {
  console.warn('wallpaper-lab register failed', e);
}
